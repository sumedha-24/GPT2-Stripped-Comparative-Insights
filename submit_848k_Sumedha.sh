...
cd ~/
source /fs/classhomes/fall2024/cmsc848k/c848k063/gpt2-venv/bin/activate
echo "venv started"
...
srun -u torchrun --standalone --nproc_per_node=4 /fs/classhomes/fall2024/cmsc848k/c848k063/848k-project/gpt2.py
